 ...
 */
  ...
  function generateCard(type, title, organisation, extent_time, description, view_type, is_vector, is_time_aware, has_info, has_viewing, has_store) {    
    ...
    else if (view_type == "detail")         html_card += "<div id=\"" + "detail_0" + "\" class=\"description_card_colored_petrol\" onmouseover=\"show_tools(\'detail_0" + "\', \'" + has_info + "\',\'" + has_viewing + "\',\'" + has_store + "\')\" onmousedown=\"focus_element(\'" + "detail_0" + "\',true)\">";
